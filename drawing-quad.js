class DrawingQuad extends PaintFunction {
    ...
    onDragging(coord, event) {
        if (!this.finish) {
            ...
            if (!this.phase_adjust) {
                ...
                this.midpt = {
                    x: (this.quadcoord.start.x + (coord[0] - this.quadcoord.start.x) / 2),
                    y: coord[1] + 10
                };
                this.endpt = {
                    x: coord[0],
    ...
    onMouseLeave() {
        ...
        if (!this.phase_adjust) {
            ...
            this.midpt = {
                x: this.quadcoord.start.x + ((this.prevCoord.x - this.quadcoord.start.x) / 2),
                y: this.prevCoord.y + 10
            };
            this.quadcoord.mid = this.midpt;
            this.quadcoord.end = this.endpt;
        } else {
    ...
    drawCPLine() {
        ...
        this.contextDraft.save();
        //circle style
        this.contextDraft.lineWidth = this.contextReal.lineWidth = 3;
