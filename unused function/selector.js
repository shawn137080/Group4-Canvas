...
class Selector extends PaintFunction{
    ...
    onMouseDown(coord,event){
        //setting style
        this.contextDraft.fillStyle = this.contextReal.fillStyle = "#ffffff";
    ...
    //internal method
    getSelected(){
        this.width = Math.abs(this.endpt.x - this.startpt.x);
        this.height = Math.abs(this.endpt.y - this.startpt.y);
        this.imageData = document.getElementById("canvas-real").getContext('2d').getImageData(this.startpt.x, this.startpt.y, this.width, this.height);
        console.log('get selected');
        //put a white rect at the real canvas draft
        this.contextReal.save();
        this.contextReal.fillStyle = "#FFFFFF";
        this.contextReal.beginPath();
        this.contextReal.fillRect(this.startpt.x, this.startpt.y, this.width, this.height);
        this.contextReal.fill();
        this.contextReal.restore();
        console.log('clearing');
        document.getElementById("canvas-draft").getContext('2d').putImageData(this.imageData, this.startpt.x, this.startpt.y);
        console.log('print selected');
    }

    putImageDraft(){
        
        document.getElementById("canvas-draft").getContext('2d').putImageData(this.imageData, this.cornerCP['1'].x, this.cornerCP['1'].y);
    }
    ...
    createCP(){
        ...
        */
        ...
        this.width = Math.abs(unrotated_end.x - unrotated_start.x);
        this.height = Math.abs(unrotated_end.y - unrotated_start.x);
    ...
    drawRect(){
        //This is only used to draw the 4 CPs and the border lines
